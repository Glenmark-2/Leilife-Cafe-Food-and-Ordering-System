...
<style>
  ...
  *::after {
  ...
  .table-wrapper {
    max-height: 70vh;
    /* Controls vertical scroll area height */
    overflow-y: auto;
  ...
  @media screen and (max-width: 720px) {
    .table-wrapper {
      overflow-x: auto;
      /* Allow horizontal scroll for mobile */
    }
    ...
    .staff-table td:nth-child(1)::before {
      content: "Name: ";
      color: var(--muted);
      font-weight: 500;
    }
    ...
    .staff-table td:nth-child(5)::before {
      content: "Date: ";
      color: var(--muted);
      font-weight: 500;
    }

    .staff-table td:nth-child(6)::before {
      content: "Actions: ";
      color: var(--muted);
      font-weight: 500;
    }
...
<div class="surface">
  ...
  <!-- Recent orders -->
  <div id="third-row" class="recent" aria-live="polite">
    <div class="recent-top">
      <p><strong>Recent Orders</strong></p>
      <div class="sort-dropdown" style="margin-left:auto;"> <label for="sort">Sort by:</label> <select id="sort" style="margin-left:6px;">
    ...
    <div id="table" role="region" aria-label="Recent Orders Table">
      <div id="table-title" aria-hidden="true">
        <p class="col-order">Order #</p>
        <p class="col-customer">Customer</p>
        <p class="col-amount">Amount</p>
        <p class="col-items">Item</p>
        <p class="col-status">Status</p>
        <p class="col-payment">Payment Status</p>
        <p class="col-method">Method</p>
        <p class="col-receipt">Download Receipt</p>
      </div>
      <div id="table-body"> <!-- rows injected by JS --> </div>
    </div> <!-- pagination -->
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (<?= $showWelcome ? 'true' : 'false' ?>) {
      ...
      if (welcomeModal) {
        ...
        window.closeWelcome = () => welcomeModal.style.display = 'none';
      }
    }
