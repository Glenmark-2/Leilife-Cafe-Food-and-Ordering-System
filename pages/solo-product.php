  ...
  <div class="product-container">
    ...
    <div class="product-details">
      ...
      <div class="flavor-section">
        <h3>Choose flavor<?= ($productId == 11 ? "s (1–3)" : "") ?>:</h3>
        ...
        <?php if ($productId == 11): ?>
        <p class="flavor-note">(Select 1–3 flavors)</p>
        <?php endif; ?>
      </div>
      <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    addBtn?.addEventListener('click', ()=>{
        ...
        // Minimum 1 flavor validation
        if(flavors.length < 1){
            alert('Please select at least one flavor.');
            return;
        }

        // Maximum 3 flavors validation for multi-flavor products
        if(checkboxes.length && flavors.length > 3){
            alert('Select up to 3 flavors.');
            return;
        }
        ...
        params.append('flavors', JSON.stringify(flavors));
