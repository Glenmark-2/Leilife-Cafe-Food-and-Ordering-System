...
function sendVerificationEmail(string $toEmail, string $token): bool {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'briana.sporer@ethereal.email';
        $mail->Password   = 'W139wm9DrnnPg4UTEz';
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;
        ...
        $mail->Body = "Hello!<br><br>
                       ...
                       <a href='{$verifyLink}' style='display:inline-block;padding:10px 20px;background:#28a745;color:#fff;text-decoration:none;border-radius:5px;'>Verify Email</a><br><br>
                       Thank you!";
