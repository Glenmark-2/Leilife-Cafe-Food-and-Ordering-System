...
// Ensure token is for a driver
if ($result['user_type'] !== 'driver') {
    jsonResponse(['success' => false, 'message' => 'Invalid reset type for this account.'], 400);
}

$driver_id = $result['user_id'];

// Update driver password
$update = $pdo->prepare("UPDATE driver_accounts SET password = :password WHERE driver_id = :id");
